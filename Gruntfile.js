...
JavaScriptCompiler.prototype.nameLookup = function(parent, name /* , type*/) {
    ...
    if (/^[0-9]+$/.test(name)) {
      ret = parent + "[" + name + "]";
       ...
       var original_lookup = parent + "." + name;
       var backbone_lookup = parent + ".get('" + name + "')";
       ret = ["((", parent, ".attributes && typeof ", parent, ".get == 'function') ? ", backbone_lookup, " : ", original_lookup, ")"].join("");
    }
    else {
      ret = parent + "['" + name + "']";
    }
